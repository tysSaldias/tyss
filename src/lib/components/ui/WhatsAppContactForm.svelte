...
{#if open}
	...
	>
		<div class="w-full max-w-md rounded-2xl bg-gray-900 shadow-2xl border border-gray-700">
			<!-- Header -->
			<div class="flex items-center justify-between border-b border-gray-700 px-6 py-4">
				<div class="flex items-center gap-3">
					...
					<h2 class="text-lg font-semibold text-white">Contacto WhatsApp</h2>
				</div>
				<button
					onclick={handleClose}
			...
			<form onsubmit={handleSubmit} class="p-6">
				...
				<div class="mb-4">
					...
					<input
						...
						class="w-full rounded-lg border border-gray-600 bg-gray-800 px-4 py-3 text-white placeholder-gray-500 transition-colors focus:border-green-500 focus:outline-none focus:ring-1 focus:ring-green-500"
					/>
					{#if errors.name}
				...
				<!-- Phone field -->
				<div class="mb-4">
					<label for="contact-phone" class="mb-1 block text-sm font-medium text-gray-300">
						Teléfono
					</label>
					<input
						id="contact-phone"
				...
				<div class="mb-6">
					<label class="flex items-start gap-3 cursor-pointer">
						<input
							...
							class="mt-1 h-4 w-4 rounded border-gray-600 bg-gray-800 text-green-500 focus:ring-green-500 focus:ring-offset-0"
						/>
				...
				<button
					type="submit"
					class="w-full rounded-lg bg-green-500 px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-green-600"
				>
					Abrir WhatsApp
				</button>
			</form>
