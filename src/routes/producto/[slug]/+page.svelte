			...
			<!-- Configurator for customizable products -->
				...
				<div class="mt-8 border-t border-brand-border pt-8">
					<button
						...
						disabled={adding}
						class="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-brand-purple px-6 py-3 text-sm font-semibold text-white transition-all hover:bg-brand-purple/90 disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-brand-purple sm:w-auto"
					>
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						class="mt-3 inline-flex items-center gap-2 text-sm text-gray-400 transition-colors hover:text-white"
					>
